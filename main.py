...
class Management:
    ...
    def AddStudent(self):
        ...
        self.surname = Label(self.frame_1, text="GRADE", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=30)
        self.surname_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.surname_entry.place(x=300,y=60, width=200)

        self.BRANCH_NAME = Label(self.frame_1, text="BRANCH_NAME", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=100)
        self.BRANCH_NAME_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.BRANCH_NAME_entry.place(x=40,y=130, width=200)
        ...
        self.STUDENTID = Label(self.frame_1, text="STUDENTID", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=170)
        self.STUDENTID_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.STUDENTID_entry.place(x=40,y=200, width=200)

        self.PAYMENT_ID = Label(self.frame_1, text="PAYMENT_ID", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=170)
        self.PAYMENT_ID_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.PAYMENT_ID_entry.place(x=300,y=200, width=200)
        ...
        self. Payement_details = Label(self.frame_1, text=" Payement_details", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=240)
        self. Payement_details_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self. Payement_details_entry.place(x=300,y=270, width=200)
    ...
    def GetUpdateDetails(self, row):
        ...
        self.BRANCH_NAME = Label(self.frame_1, text="BRANCH_NAME", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=100)
        self.BRANCH_NAME_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.BRANCH_NAME_entry.insert(0, row[2])
        self.BRANCH_NAME_entry.place(x=40,y=130, width=200)
        ...
        self.STUDENTID = Label(self.frame_1, text="STUDENTID", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=170)
        self.STUDENTID_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.STUDENTID_entry.insert(0, row[4])
        self.STUDENTID_entry.place(x=40,y=200, width=200)

        self.PAYMENT_ID = Label(self.frame_1, text="PAYMENT_ID", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=170)
        self.PAYMENT_ID_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.PAYMENT_ID_entry.insert(0, row[5])
        self.PAYMENT_ID_entry.place(x=300,y=200, width=200)
        ...
        self. Payement_details = Label(self.frame_1, text=" Payement_details", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=240)
        self. Payement_details_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self. Payement_details_entry.insert(0, row[7])
        self. Payement_details_entry.place(x=300,y=270, width=200)
    ...
    def ShowDetails(self, row):
        ...
        surname = Label(self.frame_1, text="GRADE", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=30)
        surname_data = Label(self.frame_1, text=row[1], font=(self.font_1, 10)).place(x=300, y=60)

        BRANCH_NAME = Label(self.frame_1, text="BRANCH_NAME", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=100)
        BRANCH_NAME_data = Label(self.frame_1, text=row[2], font=(self.font_1, 10)).place(x=40, y=130)
        ...
        STUDENTID = Label(self.frame_1, text="STUDENTID", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=170)
        STUDENTID_data = Label(self.frame_1, text=row[4], font=(self.font_1, 10)).place(x=40, y=200)

        PAYMENT_ID = Label(self.frame_1, text="PAYMENT_ID", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=170)
        PAYMENT_ID_data = Label(self.frame_1, text=row[5], font=(self.font_1, 10)).place(x=300, y=200)
        ...
        Payement_details = Label(self.frame_1, text=" Payement_details", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=240)
        Payement_details_data = Label(self.frame_1, text=row[7], font=(self.font_1, 10)).place(x=300, y=270)
    ...
    def UpdateDetails(self, row):
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.BRANCH_NAME_entry.get() == "" or self.subject_entry.get() == "" or self.STUDENTID_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self. Payement_details_entry.get() == "" or self.email_entry.get() == "":
            ...
            try:
                ...
                if row==None:
                    ...
                    curs.execute("update student_register set student_name=%s,grade=%s, BRANCH_NAME=%s, subject=%s, STUDENTID=%s, age=%s, gender=%s, Payement_details=%s, email=%s where contact=%s",
                                        (
                                            self.name_entry.get(),
                                            self.surname_entry.get(),
                                            self.BRANCH_NAME_entry.get(),
                                            self.subject_entry.get(),
                                            self.STUDENTID_entry.get(),
                                            self.PAYMENT_ID_entry.get(),
                                            self.gender_entry.get(),
                                            self. Payement_details_entry.get(),
    ...
    def Submit(self):
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.BRANCH_NAME_entry.get() == "" or self.subject_entry.get() == "" or self.STUDENTID_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self. Payement_details_entry.get() == "" or self.contact_entry.get() == "" or self.email_entry.get() == "":
            messagebox.showerror("Error!","Sorry!, All fields are required",parent=self.window)
        else:
            try:
                connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
                ...
                if row!=None:
                    ...
                    curs.execute("insert into student_register (student_name,grade,BRANCH_NAME,subject,STUDENTID,PAYMENT_ID,gender, Payement_details,contact,email) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                                        (
                                            self.name_entry.get(),
                                            self.surname_entry.get(),
                                            self.BRANCH_NAME_entry.get(),
